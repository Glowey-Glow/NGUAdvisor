...
namespace NGUAdvisor.Managers
{
    ...
    public static class ObjectiveParity
    {
        ...
        public enum Verdict
        {
            ...
            // The profile seats a lane 23's schema cannot NAME — BasicTrainingBP, RitualBP, BR,
        ...
        public struct Row
        {
            ...
            // Position in the PROFILE's membership order; -1 when the profile does not seat it.
        ...
        public static string Format(string pool, in Report report)
        {
            ...
            sb.Append("\n  THE PROFILE IS STILL THE ONE ALLOCATING — nothing here was applied. ")
            ...
            string heading)
        {
            ...
            foreach (var r in report.Rows)
            {
                ...
                sb.Append("\n    ").Append(r.Label);
                // The profile's ORDER is a fact only the profile has — see C6. Rendered where it
